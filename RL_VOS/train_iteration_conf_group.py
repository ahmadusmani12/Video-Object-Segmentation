...
from dataloaders import PairwiseImg_video_try as db 
import matplotlib.pyplot as plt
import random
import timeit
#from psp.model1 import CoattentionNet  
from deeplab.siamese_model_conf_try import CoattentionNet #siame_model 
